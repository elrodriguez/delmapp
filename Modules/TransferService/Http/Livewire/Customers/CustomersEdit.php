...
class CustomersEdit extends Component
{
    ...
    public function mount($id){
        ...
        //Data Of Customer
        $this->customer_id = $id;
        $this->customer_search = Customer::find($id);
    ...
    public function save(){
        $this->validate([
            ...
            'email' => 'nullable|regex:/(.+)@(.+)\.(.+)/i|min:3|max:255|unique:users,email,'.$this->person_search->id,
        ...
        $activity->dataOld(Customer::find($this->customer_search->id));
        ...
        $activity->modelOn(Customer::class, $this->customer_search->id,'customers');
