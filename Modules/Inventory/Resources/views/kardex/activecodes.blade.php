...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">@lang('inventory::labels.lbl_assets_with_code')</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><x-js-get-date></x-js-get-date></li>
@endsection
@section('subheader')
    <h1 class="subheader-title">
        <i class="fal fa-file-chart-line"></i></i> @lang('inventory::labels.lbl_assets_with_code')<sup class='badge badge-primary fw-500'>@lang('inventory::labels.lbl_list')</sup>
    </h1>
...
@endsection
@section('content')
    @livewire('inventory::kardex.active-codes')
@endsection
@section('script')
