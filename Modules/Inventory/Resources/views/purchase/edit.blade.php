...
@section('subheader')
    <h1 class="subheader-title">
        <i class="fal fa-shopping-cart"></i> @lang('inventory::labels.btn_edit') <span class='fw-300'>@lang('inventory::labels.lbl_purchase')</span> <sup class='badge badge-primary fw-500'>@lang('inventory::labels.btn_edit')</sup>
...
@endsection
@section('content')
@livewire('inventory::purchase.purchase-edit',['purchase_id' => $id])
@endsection
@section('script')
