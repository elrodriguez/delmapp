<div>
    <div class="card mb-g rounded-top">
            ...
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    <button wire:click="floorSearch" class="btn btn-default waves-effect waves-themed"
                        type="button">{{ __('labels.search') }}</button>
                    @can('restaurante_administracion_pisos_nuevo')
                        <a href="{{ route('restaurant_floors_create') }}"
                    ...
                    @if (count($floors) > 0)
                        @foreach ($floors as $key => $floor)
                            <tr>
                                ...
                                <td class="text-center tdw-50 align-middle">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu"
                                            ...
                                            @can('restaurante_administracion_pisos_editar')
                                                <a href="{{ route('restaurant_floors_edit', $floor->id) }}"
                                                    class="dropdown-item">
                                            ...
                                            @can('restaurante_administracion_pisos_eliminar')
                                                <button onclick="confirmDeleteFloor({{ $floor->id }})" type="button"
                                ...
                                <td class="align-middle">{{ $floor->establishment_name }}</td>
                                <td class="align-middle">{{ $floor->name }}</td>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto">{{ $floors->links() }}</div>
        </div>
    </div>
