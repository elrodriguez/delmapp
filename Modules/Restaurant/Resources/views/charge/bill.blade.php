...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-file-invoice-dollar'></i>Factura Electrónica
        <sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>
...
@endsection
@section('content')
    <livewire:restaurant::charge.charge-bill :order_id="$id" />
@endsection
@section('script')
