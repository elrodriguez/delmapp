...
class ModulePermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        array_push($permissions, Permission::create(['name' => 'restaurante_administracion_pisos', 'guard_name' => 'sanctum']));
        array_push($permissions, Permission::create(['name' => 'restaurante_administracion_pisos_nuevo', 'guard_name' => 'sanctum']));
        array_push($permissions, Permission::create(['name' => 'restaurante_administracion_pisos_editar', 'guard_name' => 'sanctum']));
        array_push($permissions, Permission::create(['name' => 'restaurante_administracion_pisos_eliminar', 'guard_name' => 'sanctum']));
