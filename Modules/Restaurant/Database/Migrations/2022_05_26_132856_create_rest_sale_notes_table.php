...
class CreateRestSaleNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rest_sale_notes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('order_note_id')->references('id')->on('rest_sale_notes');
    ...
    {
        Schema::dropIfExists('rest_sale_notes');
    }
}
