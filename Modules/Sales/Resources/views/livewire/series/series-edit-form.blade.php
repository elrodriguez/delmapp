<div>
    <div class="card mb-g rounded-top">
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="{{ route('sales_administration_series')}}" type="button" class="btn btn-secondary waves-effect waves-themed">{{ __('labels.list') }}</a>
    ...
    <script type="text/javascript">
        document.addEventListener('set-serie-update', event => {
