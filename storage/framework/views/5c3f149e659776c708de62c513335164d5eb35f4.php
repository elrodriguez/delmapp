...
} elseif ($_instance->childHasBeenRendered('imRNYhi')) {
    $componentId = $_instance->getRenderedChildComponentId('imRNYhi');
    $componentTag = $_instance->getRenderedChildComponentTagName('imRNYhi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('imRNYhi');
} else {
    $response = \Livewire\Livewire::mount('welcome', []);
    $html = $response->html();
    $_instance->logRenderedChild('imRNYhi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
