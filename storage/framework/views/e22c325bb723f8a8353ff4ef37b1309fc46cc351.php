...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i>Editar <span class='fw-300'>Usuario</span> <sup class='badge badge-primary fw-500'>Edit</sup>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('setting::user.user-edit',['user_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('6j2W2SU')) {
    $componentId = $_instance->getRenderedChildComponentId('6j2W2SU');
    $componentTag = $_instance->getRenderedChildComponentTagName('6j2W2SU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6j2W2SU');
} else {
    $response = \Livewire\Livewire::mount('setting::user.user-edit',['user_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('6j2W2SU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/user/edit.blade.php ENDPATH**/ ?>