        ...
        methods: {
            connect() {
                this.pusher = new Pusher(this.app.key, {
                    ...
                    disableStats: true,
                    authEndpoint: '<?php echo e(url(request()->path().'/auth')); ?>',
                    auth: {
                        headers: {
            ...
            loadChart() {
                $.getJSON('<?php echo e(url(request()->path().'/api')); ?>/' + this.app.id + '/statistics', (data) => {
            ...
            subscribeToChannel(channel) {
                this.pusher.subscribe('<?php echo e(\BeyondCode\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX); ?>' + channel)
            ...
            subscribeToStatistics() {
                this.pusher.subscribe('<?php echo e(\BeyondCode\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX); ?>statistics')
            ...
            sendEvent() {
                $.post('<?php echo e(url(request()->path().'/event')); ?>', {
...
<?php /**PATH C:\laragon\www\delmapp\vendor\beyondcode\laravel-websockets\src/../resources/views//dashboard.blade.php ENDPATH**/ ?>