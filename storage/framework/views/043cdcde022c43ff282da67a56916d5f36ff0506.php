...
} elseif ($_instance->childHasBeenRendered('RU5UICx')) {
    $componentId = $_instance->getRenderedChildComponentId('RU5UICx');
    $componentTag = $_instance->getRenderedChildComponentTagName('RU5UICx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RU5UICx');
} else {
    $response = \Livewire\Livewire::mount('inventory::kardex.items-stock');
    $html = $response->html();
    $_instance->logRenderedChild('RU5UICx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/kardex/itemsstock.blade.php ENDPATH**/ ?>