...
} elseif ($_instance->childHasBeenRendered('VgFzFAu')) {
    $componentId = $_instance->getRenderedChildComponentId('VgFzFAu');
    $componentTag = $_instance->getRenderedChildComponentTagName('VgFzFAu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VgFzFAu');
} else {
    $response = \Livewire\Livewire::mount('restaurant::categories.categories-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('VgFzFAu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/categories/create.blade.php ENDPATH**/ ?>