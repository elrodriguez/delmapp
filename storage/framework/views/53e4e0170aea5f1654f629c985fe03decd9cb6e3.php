...
} elseif ($_instance->childHasBeenRendered('0A1KyVG')) {
    $componentId = $_instance->getRenderedChildComponentId('0A1KyVG');
    $componentTag = $_instance->getRenderedChildComponentTagName('0A1KyVG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0A1KyVG');
} else {
    $response = \Livewire\Livewire::mount('staff::companies.companies-search');
    $html = $response->html();
    $_instance->logRenderedChild('0A1KyVG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('staff::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Staff\Resources/views/companies/search.blade.php ENDPATH**/ ?>