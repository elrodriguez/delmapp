...
<?php $__env->startSection('styles'); ?>
    ...
    <link rel="stylesheet" media="screen, print"
        href="<?php echo e(url('themes/smart-admin/css/notifications/toastr/toastr.css')); ?>">
...
} elseif ($_instance->childHasBeenRendered('TBtXSth')) {
    $componentId = $_instance->getRenderedChildComponentId('TBtXSth');
    $componentTag = $_instance->getRenderedChildComponentTagName('TBtXSth');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TBtXSth');
} else {
    $response = \Livewire\Livewire::mount('restaurant::attend.attend-tables', []);
    $html = $response->html();
    $_instance->logRenderedChild('TBtXSth', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('Ingwxsn')) {
    $componentId = $_instance->getRenderedChildComponentId('Ingwxsn');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ingwxsn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ingwxsn');
} else {
    $response = \Livewire\Livewire::mount('restaurant::attend.attend-order', []);
    $html = $response->html();
    $_instance->logRenderedChild('Ingwxsn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('VLdvNNP')) {
    $componentId = $_instance->getRenderedChildComponentId('VLdvNNP');
    $componentTag = $_instance->getRenderedChildComponentTagName('VLdvNNP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VLdvNNP');
} else {
    $response = \Livewire\Livewire::mount('restaurant::attend.attend-re-order', []);
    $html = $response->html();
    $_instance->logRenderedChild('VLdvNNP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/attend/index.blade.php ENDPATH**/ ?>