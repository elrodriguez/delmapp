<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="tableSearch" wire:model.defer="search" type="text"
                    class="form-control border-left-0 bg-transparent pl-0" placeholder="Escriba aquí...">
                <div class="input-group-append">
                    <button wire:click="tableSearch" class="btn btn-default waves-effect waves-themed"
                        type="button">Buscar</button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_mesas_nuevo')): ?>
                        <a href="<?php echo e(route('restaurant_tables_create')); ?>"
            ...
            <table class="table m-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><?php echo e(__('restaurant::labels.chairs')); ?></th>
                        <th class="text-center"><?php echo e(__('restaurant::labels.occupied')); ?></th>
                    ...
                    <?php if(count($tables) > 0): ?>
                        <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center tdw-50 align-middle">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_mesas_editar')): ?>
                                                <a href="<?php echo e(route('restaurant_tables_edit', $table->id)); ?>"
                                                    class="dropdown-item">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_mesas_eliminar')): ?>
                                                <button onclick="confirmDeletetable(<?php echo e($table->id); ?>)" type="button"
                                ...
                                <td class="align-middle"><?php echo e($table->name); ?></td>
                                <td class="align-middle"><?php echo e($table->description); ?></td>
                                <td class="align-middle text-right"><?php echo e($table->chairs); ?></td>
                                <td class="align-middle text-center">
                                    <?php if($table->occupied): ?>
                                        <span class="badge badge-warning"><?php echo e(__('labels.yes')); ?></span>
                                    <?php else: ?>
                                        <span class="badge badge-danger"><?php echo e(__('labels.no')); ?></span>
                                    <?php endif; ?>
                                </td>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($tables->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        ...
        document.addEventListener('set-table-delete', event => {
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/livewire/tables/tables-list.blade.php ENDPATH**/ ?>