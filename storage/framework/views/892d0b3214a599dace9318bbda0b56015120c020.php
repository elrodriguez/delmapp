...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active">
        <?php echo e(__('restaurant::labels.list_orders')); ?>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::orders.orders-list', [])->html();
} elseif ($_instance->childHasBeenRendered('6SxLhMD')) {
    $componentId = $_instance->getRenderedChildComponentId('6SxLhMD');
    $componentTag = $_instance->getRenderedChildComponentTagName('6SxLhMD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6SxLhMD');
} else {
    $response = \Livewire\Livewire::mount('restaurant::orders.orders-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('6SxLhMD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function refreshalert() {
            ...
            initApp.playSound("<?php echo e(url('themes/smart-admin/media/sound')); ?>", 'smallbox')
            toastr.options = {
                "closeButton": false,
                "debug": false,
                "newestOnTop": true,
...
<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/orders/index.blade.php ENDPATH**/ ?>