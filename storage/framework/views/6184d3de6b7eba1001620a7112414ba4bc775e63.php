...
} elseif ($_instance->childHasBeenRendered('4h6iEuq')) {
    $componentId = $_instance->getRenderedChildComponentId('4h6iEuq');
    $componentTag = $_instance->getRenderedChildComponentTagName('4h6iEuq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4h6iEuq');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-list');
    $html = $response->html();
    $_instance->logRenderedChild('4h6iEuq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('OD16Mi3')) {
    $componentId = $_instance->getRenderedChildComponentId('OD16Mi3');
    $componentTag = $_instance->getRenderedChildComponentTagName('OD16Mi3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OD16Mi3');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-modal-payments');
    $html = $response->html();
    $_instance->logRenderedChild('OD16Mi3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
