...
} elseif ($_instance->childHasBeenRendered('4Lebmtn')) {
    $componentId = $_instance->getRenderedChildComponentId('4Lebmtn');
    $componentTag = $_instance->getRenderedChildComponentTagName('4Lebmtn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4Lebmtn');
} else {
    $response = \Livewire\Livewire::mount('sales::document.document-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('4Lebmtn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
