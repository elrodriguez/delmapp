...
} elseif ($_instance->childHasBeenRendered('jkTZ0ae')) {
    $componentId = $_instance->getRenderedChildComponentId('jkTZ0ae');
    $componentTag = $_instance->getRenderedChildComponentTagName('jkTZ0ae');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jkTZ0ae');
} else {
    $response = \Livewire\Livewire::mount('sales::document.document-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('jkTZ0ae', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
