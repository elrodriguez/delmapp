<div class="page-logo">
    <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
        <?php if($this->company): ?>
                ...
                <img src="<?php echo e(asset($this->company->logo)); ?>" alt="<?php echo e(config('app.name', 'Laravel')); ?>" aria-roledescription="logo">
...
</div><?php /**PATH C:\laragon\www\delmapp\resources\views/components/company-logo.blade.php ENDPATH**/ ?>