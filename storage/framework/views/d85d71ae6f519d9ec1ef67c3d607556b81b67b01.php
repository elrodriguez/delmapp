...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('inventory::category.category-list')->html();
} elseif ($_instance->childHasBeenRendered('Fkpzjw1')) {
    $componentId = $_instance->getRenderedChildComponentId('Fkpzjw1');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fkpzjw1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fkpzjw1');
} else {
    $response = \Livewire\Livewire::mount('inventory::category.category-list');
    $html = $response->html();
    $_instance->logRenderedChild('Fkpzjw1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/category/index.blade.php ENDPATH**/ ?>