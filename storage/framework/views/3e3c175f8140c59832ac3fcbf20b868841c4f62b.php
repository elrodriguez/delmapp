            ...
            <form class="needs-validation <?php echo e($errors->any() ? 'was-validated' : ''); ?>" novalidate="">
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="xuuid"><?php echo e(__('labels.code')); ?> <span
                                class="text-danger">*</span>
                        </label>
                        <input wire:model.defer="xuuid" type="text" class="form-control" id="xuuid">
                        <?php $__errorArgs = ['xuuid'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="logo"><?php echo app('translator')->get('setting::labels.icon'); ?> <span
                                class="text-danger">*</span> </label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i
                                        class="<?php echo e($logo ? $logo : 'fal fa-wrench'); ?> fs-xl"></i></span>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="label"><?php echo app('translator')->get('setting::labels.name'); ?> <span
                                class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="destination_route"><?php echo app('translator')->get('setting::labels.destination_route'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label"><?php echo app('translator')->get('setting::labels.state'); ?> <span
                                class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="<?php echo e(route('setting_modules')); ?>" type="button"
    ...
    <script type="text/javascript">
        document.addEventListener('set-modules-save', event => {
            ...
            let box = bootbox.alert({
                ...
                message: "<span><strong><?php echo e(__('setting::labels.excellent')); ?>... </strong>" + event
                    .detail.msg + "</span>",
                centerVertical: true,
...
} elseif ($_instance->childHasBeenRendered('l2367558502-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2367558502-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2367558502-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2367558502-0');
} else {
    $response = \Livewire\Livewire::mount('setting::modal-icon');
    $html = $response->html();
    $_instance->logRenderedChild('l2367558502-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/livewire/modules/module-edit.blade.php ENDPATH**/ ?>