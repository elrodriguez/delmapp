    ...
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('setting_modules_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                </div>
            </div>
        </div>
        <div class="card-body p-0">
            <table class="table m-0">
                <thead>
                    <tr>
                        <th class="text-center"><?php echo e(__('setting::labels.thnum')); ?></th>
                        <th class="text-center"><?php echo e(__('setting::labels.actions')); ?></th>
                        <th><?php echo e(__('setting::labels.name')); ?></th>
                        <th class="text-center"><?php echo e(__('setting::labels.icon')); ?></th>
                ...
                <tbody class="">
                    ...
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_modulos_editar')): ?>
                                    <a href="<?php echo e(route('setting_modules_edit',$module->id)); ?>" class="dropdown-item">
                                        <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('setting::labels.edit')); ?>

                                    </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_modulos_permisos')): ?>
                                    <a href="<?php echo e(route('setting_modules_permissions',$module->id)); ?>" class="dropdown-item">
                                        <i class="fal fa-lock-open-alt mr-1"></i><?php echo e(__('setting::labels.permissions')); ?>

                                    </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_modulos_eliminar')): ?>
                                    <div class="dropdown-divider"></div>
                                    <button onclick="confirmDelete(<?php echo e($module->id); ?>)" type="button" class="dropdown-item text-danger">
                        ...
                        <td class="align-middle"><?php echo e($module->label); ?></td>
                        <td class="text-center align-middle"><i class="<?php echo e($module->logo); ?>"></i></td>
                        <td class="text-center align-middle">
                            <?php if($module->status): ?>
                            <span class="badge badge-warning"><?php echo e(__('setting::labels.active')); ?></span>
                            <?php else: ?>
                            <span class="badge badge-danger"><?php echo e(__('setting::labels.inactive')); ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($modules->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDelete(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                        window.livewire.find('<?php echo e($_instance->id); ?>').deleteModule(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/livewire/modules/module-list.blade.php ENDPATH**/ ?>