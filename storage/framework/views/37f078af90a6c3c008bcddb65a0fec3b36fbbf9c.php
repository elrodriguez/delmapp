...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('sales::labels.series')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-hashtag"></i></i><?php echo e(__('sales::labels.series')); ?><sup class='badge badge-primary fw-500'>List</sup>   
    </h1>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sales::series.series-list')->html();
} elseif ($_instance->childHasBeenRendered('S3A8OoU')) {
    $componentId = $_instance->getRenderedChildComponentId('S3A8OoU');
    $componentTag = $_instance->getRenderedChildComponentTagName('S3A8OoU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('S3A8OoU');
} else {
    $response = \Livewire\Livewire::mount('sales::series.series-list');
    $html = $response->html();
    $_instance->logRenderedChild('S3A8OoU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('sales::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Sales\Resources/views/series/index.blade.php ENDPATH**/ ?>