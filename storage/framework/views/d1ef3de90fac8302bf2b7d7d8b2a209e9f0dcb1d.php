...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('sales_documents_sale_notes')); ?>" ><?php echo app('translator')->get('sales::labels.sales_notes'); ?></a></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-file-invoice-dollar'></i><?php echo e(__('sales::labels.sales_notes')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.new')); ?></sup>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sales::document.sale-notes-create-form')->html();
} elseif ($_instance->childHasBeenRendered('yMF9mM1')) {
    $componentId = $_instance->getRenderedChildComponentId('yMF9mM1');
    $componentTag = $_instance->getRenderedChildComponentTagName('yMF9mM1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yMF9mM1');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('yMF9mM1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('sales::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Sales\Resources/views/document/sale_notes_create.blade.php ENDPATH**/ ?>