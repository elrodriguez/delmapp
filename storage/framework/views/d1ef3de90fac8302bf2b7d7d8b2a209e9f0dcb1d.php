...
} elseif ($_instance->childHasBeenRendered('SDga6d9')) {
    $componentId = $_instance->getRenderedChildComponentId('SDga6d9');
    $componentTag = $_instance->getRenderedChildComponentTagName('SDga6d9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SDga6d9');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('SDga6d9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
