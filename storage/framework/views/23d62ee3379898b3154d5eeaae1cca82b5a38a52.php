...
} elseif ($_instance->childHasBeenRendered('LL222TY')) {
    $componentId = $_instance->getRenderedChildComponentId('LL222TY');
    $componentTag = $_instance->getRenderedChildComponentTagName('LL222TY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LL222TY');
} else {
    $response = \Livewire\Livewire::mount('restaurant::floors.floors-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('LL222TY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/floors/index.blade.php ENDPATH**/ ?>