...
} elseif ($_instance->childHasBeenRendered('MsLs8lJ')) {
    $componentId = $_instance->getRenderedChildComponentId('MsLs8lJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('MsLs8lJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MsLs8lJ');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::medicines.medicines-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('MsLs8lJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
