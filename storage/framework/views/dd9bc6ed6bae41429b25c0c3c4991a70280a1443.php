...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('pharmacy_administration_medicines')); ?>"><?php echo e(__('pharmacy::labels.medicines')); ?></a></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-briefcase-medical"></i></i><?php echo e(__('pharmacy::labels.medicines')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.new')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::medicines.medicines-create', [])->html();
} elseif ($_instance->childHasBeenRendered('hdNVK3o')) {
    $componentId = $_instance->getRenderedChildComponentId('hdNVK3o');
    $componentTag = $_instance->getRenderedChildComponentTagName('hdNVK3o');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hdNVK3o');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::medicines.medicines-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('hdNVK3o', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('pharmacy::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Pharmacy\Resources/views/medicines/create.blade.php ENDPATH**/ ?>