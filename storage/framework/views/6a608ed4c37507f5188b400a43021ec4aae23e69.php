...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('inventory_purchase')); ?>"><?php echo app('translator')->get('inventory::labels.lbl_shopping'); ?></a>
    </li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="fal fa-shopping-cart"></i> <?php echo app('translator')->get('inventory::labels.lbl_new'); ?> <span
            class='fw-300'><?php echo app('translator')->get('inventory::labels.lbl_purchase'); ?></span> <sup
            class='badge badge-primary fw-500'><?php echo app('translator')->get('inventory::labels.btn_new'); ?></sup>
...
<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/purchase/create.blade.php ENDPATH**/ ?>