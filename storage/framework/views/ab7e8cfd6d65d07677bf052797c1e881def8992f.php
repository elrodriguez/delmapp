...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label class="form-label" for="tradename"><?php echo app('translator')->get('setting::labels.tradename'); ?> <span
                            class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="<?php echo e(route('setting_company')); ?>" type="button"
                class="btn btn-secondary waves-effect waves-themed"><?php echo e(__('setting::buttons.list')); ?></a>
            <button wire:click="save" wire:loading.attr="disabled" type="button"
                class="btn btn-info ml-auto waves-effect waves-themed"><?php echo e(__('setting::buttons.save')); ?></button>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/livewire/company/company-edit.blade.php ENDPATH**/ ?>