...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo e(__('pharmacy::labels.symptom')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-sad-tear"></i></i><?php echo e(__('pharmacy::labels.symptom')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.list')); ?></sup>   
    </h1>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::symptom.symptom-list', [])->html();
} elseif ($_instance->childHasBeenRendered('i6Mwvxo')) {
    $componentId = $_instance->getRenderedChildComponentId('i6Mwvxo');
    $componentTag = $_instance->getRenderedChildComponentTagName('i6Mwvxo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('i6Mwvxo');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::symptom.symptom-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('i6Mwvxo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pharmacy::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Pharmacy\Resources/views/symptom/index.blade.php ENDPATH**/ ?>