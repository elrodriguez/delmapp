...
<?php endif; ?>
        <ul id="js-nav-menu" class="nav-menu">
                    ...
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_categorias')): ?>
                            <li
                                ...
                                <a href="<?php echo e(route('restaurant_categories_list')); ?>" title="<?php echo app('translator')->get('restaurant::labels.categories'); ?>"
                                    data-filter-tags="<?php echo app('translator')->get('restaurant::labels.categories'); ?>">
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.categories'); ?>"><?php echo app('translator')->get('restaurant::labels.categories'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_pisos')): ?>
                            <li
                                class="<?php echo e($path[0] == 'restaurant' && $path[1] == 'administration' && $path[2] == 'floors' ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('restaurant_floors_list')); ?>" title="<?php echo app('translator')->get('restaurant::labels.floor'); ?>"
                                    data-filter-tags="<?php echo app('translator')->get('restaurant::labels.floor'); ?>">
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.floor'); ?>"><?php echo app('translator')->get('restaurant::labels.floor'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_mesas')): ?>
                            <li
                                ...
                                <a href="<?php echo e(route('restaurant_tables_list')); ?>" title="<?php echo app('translator')->get('restaurant::labels.tables'); ?>"
                                    ...
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.tables'); ?>"><?php echo app('translator')->get('restaurant::labels.tables'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_comandas')): ?>
                            <li
                                ...
                                <a href="<?php echo e(route('restaurant_commands_list')); ?>" title="<?php echo app('translator')->get('restaurant::labels.commands'); ?>"
                                    data-filter-tags="<?php echo app('translator')->get('restaurant::labels.commands'); ?>">
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.commands'); ?>"><?php echo app('translator')->get('restaurant::labels.commands'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_panel')): ?>
                <li class="<?php echo e($path[0] == 'restaurant' && $path[1] == 'panels' ? 'active open' : ''); ?>">
                    <a href="javascript:void(0);" title="panels" data-filter-tags="panels">
                        <i class="fal fa-window-restore"></i>
                        <span class="nav-link-text"
                            data-i18n="nav.clientes"><?php echo e(__('restaurant::labels.panels')); ?></span>
                    </a>
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_panel_atender')): ?>
                            <li
                                class="<?php echo e($path[0] == 'restaurant' && $path[1] == 'panels' && $path[2] == 'tables' ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('restaurant_panels_tables')); ?>" title="<?php echo app('translator')->get('restaurant::labels.attend'); ?>"
                                    data-filter-tags="<?php echo app('translator')->get('restaurant::labels.attend'); ?>">
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.attend'); ?>"><?php echo app('translator')->get('restaurant::labels.attend'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_panel_delivery')): ?>
                            <li class="<?php echo e($path[0] == 'restaurant' && $path[1] == 'panels' && $path[2] == 'deliveries' ? 'active' : ''); ?>">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_panel_pedidos')): ?>
                            <li
                                class="<?php echo e($path[0] == 'restaurant' && $path[1] == 'panels' && $path[2] == 'orders' ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('restaurant_panels_orders')); ?>" title="<?php echo app('translator')->get('restaurant::labels.list_orders'); ?>"
                                    data-filter-tags="<?php echo app('translator')->get('restaurant::labels.list_orders'); ?>">
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.list_orders'); ?>"><?php echo app('translator')->get('restaurant::labels.list_orders'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_panel_cobrar')): ?>
                            <li
                                class="<?php echo e($path[0] == 'restaurant' && $path[1] == 'panels' && $path[2] == 'charge' ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('restaurant_panels_charge')); ?>" title="<?php echo app('translator')->get('restaurant::labels.orders_receivable'); ?>"
                                    data-filter-tags="<?php echo app('translator')->get('restaurant::labels.orders_receivable'); ?>">
                                    <span class="nav-link-text" data-i18n="nav.<?php echo app('translator')->get('restaurant::labels.orders_receivable'); ?>"><?php echo app('translator')->get('restaurant::labels.orders_receivable'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/livewire/sidebar.blade.php ENDPATH**/ ?>