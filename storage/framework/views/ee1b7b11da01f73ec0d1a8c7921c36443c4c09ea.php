...
} elseif ($_instance->childHasBeenRendered('EAnsKr4')) {
    $componentId = $_instance->getRenderedChildComponentId('EAnsKr4');
    $componentTag = $_instance->getRenderedChildComponentTagName('EAnsKr4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EAnsKr4');
} else {
    $response = \Livewire\Livewire::mount('staff::companies.companies-search');
    $html = $response->html();
    $_instance->logRenderedChild('EAnsKr4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('MIPQdYY')) {
    $componentId = $_instance->getRenderedChildComponentId('MIPQdYY');
    $componentTag = $_instance->getRenderedChildComponentTagName('MIPQdYY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MIPQdYY');
} else {
    $response = \Livewire\Livewire::mount('staff::companies.companies-create', ['id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('MIPQdYY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('staff::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Staff\Resources/views/companies/create.blade.php ENDPATH**/ ?>