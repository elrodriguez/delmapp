<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('pharmacy_administration_symptom_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                <thead>
                    <tr>
                        ...
                        <th class=""><?php echo e(__('labels.description')); ?></th>
                    </tr>
                </thead>
                <tbody class="">
                    <?php if(count($symptom)>0): ?>
                        <?php $__currentLoopData = $symptom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center tdw-50 align-middle">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                        <a href="<?php echo e(route('pharmacy_administration_symptom_edit',$item->id)); ?>" class="dropdown-item">
                                            <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <button onclick="confirmDeleteRelated('<?php echo e($item->id); ?>')" type="button" class="dropdown-item text-danger">
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($symptom->links()); ?></div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Pharmacy\Resources/views/livewire/symptom/symptom-list.blade.php ENDPATH**/ ?>