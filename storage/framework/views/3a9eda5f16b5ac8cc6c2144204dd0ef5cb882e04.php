                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3" wire:ignore>
                            <label class="form-label" for="item_text"><?php echo app('translator')->get('inventory::labels.lbl_item'); ?> <span
                                    class="text-danger">*</span> </label>
                            <input wire:model.defer="item_text" id="item_text" required=""
                            ...
                            <input wire:model.defer="item_id" id="item_id" type="hidden" placeholder=""
                                autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2 mb-3" style="margin-top: 23px;">
                            ...
                            <?php endif; ?>
                            <?php if($btn_save_item): ?>
                                <a onclick="validateEditSaveItem()" wire:loading.attr="disabled"
                                    class="btn btn-primary ml-auto waves-effect waves-themed" style="color: white;"><i
                                        class="fal fa-save"></i> <?php echo app('translator')->get('inventory::labels.btn_update'); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="form-row">
                                                ...
                                                <td class="text-center align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <button wire:click="editItem(<?php echo e($item['id']); ?>)"
                                                            type="button"
                                                            class="btn btn-info waves-effect waves-themed"><i
                                                                class="fal fa-pencil-alt"></i></button>
                                                        <button onclick="confirmDeleteItem(<?php echo e($item['id']); ?>)"
                                                            type="button"
                                                            class="btn btn-danger waves-effect waves-themed"><i
    ...
    <script type="text/javascript">
        ...
        function validateEditSaveItem() {
            let id_pp = $("#item_id").val();
            if (id_pp > 0) {
                $('#item_text').css('color', '');
                $('#item_text').css('border-color', '');
                window.livewire.find('<?php echo e($_instance->id); ?>').saveEditItem();
            } else {
                alert("Busque y seleccione el Item ha agregar.");
                $('#item_text').css('color', 'red');
                $('#item_text').css('border-color', 'red');
        ...
        document.addEventListener('inv-purchase-edit', event => {
        ...
        document.addEventListener('inv-purchase-edit-not', event => {
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/livewire/purchase/purchase-edit.blade.php ENDPATH**/ ?>