<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('pharmacy_administration_diseases_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                </div>
            </div>
        </div>
                ...
                <tbody class="">
                    <?php if(count($diseases)>0): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center tdw-50 align-middle">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                        <a href="<?php echo e(route('pharmacy_administration_diseases_edit',$disease->id)); ?>" class="dropdown-item">
                                            <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                        </a>
                                        <a href="<?php echo e(route('pharmacy_administration_diseases_symptoms',$disease->id)); ?>" class="dropdown-item">
                                            <i class="fal fa-sad-tear mr-1"></i><?php echo e(__('pharmacy::labels.symptom')); ?>

                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <button onclick="confirmDeleteRelated('<?php echo e($disease->id); ?>')" type="button" class="dropdown-item text-danger">
                            ...
                            <td class="align-middle"><?php echo e($disease->name); ?></td>
                            <td class="align-middle text-center">
                                <?php if($disease->fracture): ?>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($diseases->links()); ?></div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Pharmacy\Resources/views/livewire/diseases/diseases-list.blade.php ENDPATH**/ ?>