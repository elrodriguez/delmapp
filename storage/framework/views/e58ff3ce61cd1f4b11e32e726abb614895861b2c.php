...
} elseif ($_instance->childHasBeenRendered('INTWsuR')) {
    $componentId = $_instance->getRenderedChildComponentId('INTWsuR');
    $componentTag = $_instance->getRenderedChildComponentTagName('INTWsuR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('INTWsuR');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::medicines.medicines-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('INTWsuR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
