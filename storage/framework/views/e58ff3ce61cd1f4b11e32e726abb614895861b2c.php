...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo e(__('pharmacy::labels.medicines')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-briefcase-medical"></i></i><?php echo e(__('pharmacy::labels.medicines')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.list')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::medicines.medicines-list', [])->html();
} elseif ($_instance->childHasBeenRendered('zjldTLt')) {
    $componentId = $_instance->getRenderedChildComponentId('zjldTLt');
    $componentTag = $_instance->getRenderedChildComponentTagName('zjldTLt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zjldTLt');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::medicines.medicines-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('zjldTLt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pharmacy::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Pharmacy\Resources/views/medicines/index.blade.php ENDPATH**/ ?>