...
<body>
    ...
    <table class="full-width mt-5">
        <tr>
            ...
            <td width="15%"><?php echo e(\Carbon\Carbon::parse($document->date_of_issue)->format('Y-m-d')); ?></td>
        </tr>
        <tr>
        ...
        <tbody>
            <?php $__currentLoopData = $document->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-center align-top">
                        <?php if($row->item_type == 'Modules\Restaurant\Entities\RestCommand'): ?>
                            NIU
                        <?php else: ?>
                    ...
                    <td class="text-left">
                        ...
                        <?php if($row->attributes): ?>
                            <?php $__currentLoopData = $row->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <br /><span style="font-size: 9px"><?php echo $attr->description; ?> :
                                    <?php echo e($attr->value); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                        <?php if($row->discounts): ?>
                            <?php $__currentLoopData = $row->discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dtos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <br /><span style="font-size: 9px"><?php echo e($dtos->factor * 100); ?>%
                                    <?php echo e($dtos->description); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
            ...
            <?php if($document->total_taxed > 0): ?>
                <tr>
                    <td colspan="7" class="text-right font-bold">OP. GRAVADAS: <?php echo e($document->currency_type->symbol); ?>
            ...
            <tr>
                <td colspan="7" class="text-right font-bold">TOTAL A PAGAR: <?php echo e($document->currency_type->symbol); ?>
    ...
    <table class="full-width">
        ...
        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td>- <?php echo e($row->date_of_payment->format('d/m/Y')); ?> - <?php echo e($row->payment_method_type->description); ?>

                    - <?php echo e($row->reference ? $row->reference . ' - ' : ''); ?> <?php echo e($document->currency_type->symbol); ?>

                    <?php echo e($row->payment); ?></td>
            </tr>
            <?php
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><strong>SALDO:</strong> <?php echo e($document->currency_type->symbol); ?>

                <?php echo e(number_format($document->total - $payment, 2)); ?></td>
        </tr>
    </table>
</body>

</html>
<?php /**PATH C:\laragon\www\delmapp\app\CoreBilling\Templates/pdf/default/rest_sale_note_a4.blade.php ENDPATH**/ ?>