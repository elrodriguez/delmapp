<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('sales_administration_series_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><?php echo e(__('labels.serie')); ?></th>
                        <th class="text-center"><?php echo e(__('labels.number')); ?></th>
                        <th><?php echo e(__('labels.establishment')); ?></th>
                        <th><?php echo e(__('labels.voucher_type')); ?></th>
                        <th class="text-center"><?php echo e(__('labels.state')); ?></th>
                    </tr>
                </thead>
                <tbody class="">
                    <?php if(count($series)>0): ?>
                        <?php $__currentLoopData = $series; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $serie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center tdw-50 align-middle">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ventas_administration_series_editar')): ?>
                                        <a href="<?php echo e(route('sales_administration_serie_edit',$serie->id)); ?>" class="dropdown-item">
                                            <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                        </a>
                                        <?php endif; ?>
                                        <div class="dropdown-divider"></div>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ventas_administration_series_eliminar')): ?>
                                        <button onclick="confirmDelete('<?php echo e($serie->id); ?>')" type="button" class="dropdown-item text-danger">
                            ...
                            <td class="align-middle text-center"><?php echo e($serie->id); ?></td>
                            <td class="align-middle text-right"><?php echo e($serie->correlative); ?></td>
                            <td class="align-middle"><?php echo e($serie->name); ?></td>
                            <td class="align-middle"><?php echo e($serie->description); ?></td>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($series->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDelete(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                        window.livewire.find('<?php echo e($_instance->id); ?>').deleteserie(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Sales\Resources/views/livewire/series/series-list.blade.php ENDPATH**/ ?>