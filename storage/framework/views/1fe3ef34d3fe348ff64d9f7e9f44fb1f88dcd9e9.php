<div class="p-3 bg-warning-200 rounded overflow-hidden position-relative text-white mb-g">
    <div class="">
        <h3 class="display-4 d-block l-h-n m-0 fw-500">
            ...
            <small class="m-0 l-h-n"><?php echo e(__('staff::labels.lbl_employees')); ?></small>
        </h3>
    </div>
    <i class="fal fa-users position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
</div><?php /**PATH C:\laragon\www\delmapp\Modules/Staff\Resources/views/livewire/employees/employees-quantity.blade.php ENDPATH**/ ?>