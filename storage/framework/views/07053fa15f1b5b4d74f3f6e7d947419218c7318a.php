...
} elseif ($_instance->childHasBeenRendered('Z1NC6Ob')) {
    $componentId = $_instance->getRenderedChildComponentId('Z1NC6Ob');
    $componentTag = $_instance->getRenderedChildComponentTagName('Z1NC6Ob');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z1NC6Ob');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::diseases.diseases-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('Z1NC6Ob', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pharmacy::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Pharmacy\Resources/views/diseases/index.blade.php ENDPATH**/ ?>