<div >
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            var filename = "<?php echo e(url('themes/smart-admin/media/data/fa-icon-list')); ?>"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list]
            ...
            $.getJSON(filename + ".json").then(function(data)
            {
                ...
                $('.js-showcase-icon').click(function()
                {
                    ...
                    window.livewire.find('<?php echo e($_instance->id); ?>').emit('iconAdded', iconClass);
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/livewire/modal-icon.blade.php ENDPATH**/ ?>