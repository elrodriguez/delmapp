...
} elseif ($_instance->childHasBeenRendered('ADzgHc7')) {
    $componentId = $_instance->getRenderedChildComponentId('ADzgHc7');
    $componentTag = $_instance->getRenderedChildComponentTagName('ADzgHc7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ADzgHc7');
} else {
    $response = \Livewire\Livewire::mount('inventory::purchase.purchase-list');
    $html = $response->html();
    $_instance->logRenderedChild('ADzgHc7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/purchase/index.blade.php ENDPATH**/ ?>