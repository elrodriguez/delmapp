        ...
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('sales_documents_sale_notes_create')); ?>"
                ...
                <table class="table m-0">
                    ...
                    <tbody class="">
                        ...
                        <tr>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ventas_nota_venta_editar')): ?>
                                                <?php if($note->module==1): ?>
                                                <a href="<?php echo e(route('sales_documents_sale_notes_edit',$note->external_id)); ?>"
                                                    class="dropdown-item">
                                                    <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                                </a>
                                                <?php elseif($note->module==2): ?>
                                                <a href="<?php echo e(route('sales_documents_sale_notes_edit_rest',$note->external_id)); ?>"
                                                    class="dropdown-item">
                                                    <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>
                                        ...
                                        <button onclick="confirmCancel(<?php echo e($note->id); ?>)" type="button"
                            ...
                            <td class="align-middle text-center"><?php echo e($note->series.'-'.str_pad($note->number, 8, "0",
                                STR_PAD_LEFT)); ?></td>
                            ...
                            <td class="align-middle">
                                ...
                                <?php endif; ?>
                                        ...
                                        <td class="align-middle text-center">
                                            <button wire:click="$emit('openModalNotePaymentsSal',<?php echo e($note->id); ?>)"
                                        ...
                                        <?php elseif($note->module==2): ?>
                                        <td class="align-middle text-center">
                                            <button wire:click="$emit('openModalNotePaymentsRest',<?php echo e($note->id); ?>)"
                                                class="btn btn-warning btn-icon rounded-circle waves-effect waves-themed">
                                                <i class="fal fa-comment-alt-dollar"></i>
                                            </button>
                                        </td>
                        ...
                        <?php else: ?>
                        <tr class="odd">
                            <td valign="top" colspan="10" class="dataTables_empty text-center"><?php echo e(__('labels.no_records_to_display')); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Sales\Resources/views/livewire/document/sale-notes-list.blade.php ENDPATH**/ ?>