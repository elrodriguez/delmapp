...
} elseif ($_instance->childHasBeenRendered('JUiWrCo')) {
    $componentId = $_instance->getRenderedChildComponentId('JUiWrCo');
    $componentTag = $_instance->getRenderedChildComponentTagName('JUiWrCo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JUiWrCo');
} else {
    $response = \Livewire\Livewire::mount('inventory::brand.brand-create');
    $html = $response->html();
    $_instance->logRenderedChild('JUiWrCo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/brand/create.blade.php ENDPATH**/ ?>