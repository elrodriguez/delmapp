...
<?php endif; ?>
    ...
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('restaurant_floors_list')); ?>"><?php echo e(__('restaurant::labels.floor')); ?></a>
    </li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        ...
        <?php echo e(__('restaurant::labels.floor')); ?>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::floors.floors-edit', ['floorId' => $id,'floor_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('dDaQKRa')) {
    $componentId = $_instance->getRenderedChildComponentId('dDaQKRa');
    $componentTag = $_instance->getRenderedChildComponentTagName('dDaQKRa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dDaQKRa');
} else {
    $response = \Livewire\Livewire::mount('restaurant::floors.floors-edit', ['floorId' => $id,'floor_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('dDaQKRa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/floors/edit.blade.php ENDPATH**/ ?>