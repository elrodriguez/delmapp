...
} elseif ($_instance->childHasBeenRendered('44pkRU4')) {
    $componentId = $_instance->getRenderedChildComponentId('44pkRU4');
    $componentTag = $_instance->getRenderedChildComponentTagName('44pkRU4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('44pkRU4');
} else {
    $response = \Livewire\Livewire::mount('restaurant::categories.categories-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('44pkRU4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/categories/index.blade.php ENDPATH**/ ?>