...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::floors.floors-create', [])->html();
} elseif ($_instance->childHasBeenRendered('Hn3AkSt')) {
    $componentId = $_instance->getRenderedChildComponentId('Hn3AkSt');
    $componentTag = $_instance->getRenderedChildComponentTagName('Hn3AkSt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Hn3AkSt');
} else {
    $response = \Livewire\Livewire::mount('restaurant::floors.floors-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('Hn3AkSt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/floors/create.blade.php ENDPATH**/ ?>