...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('inventory_category')); ?>">Categorias</a></li>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('inventory::category.category-create')->html();
} elseif ($_instance->childHasBeenRendered('NMeODhv')) {
    $componentId = $_instance->getRenderedChildComponentId('NMeODhv');
    $componentTag = $_instance->getRenderedChildComponentTagName('NMeODhv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NMeODhv');
} else {
    $response = \Livewire\Livewire::mount('inventory::category.category-create');
    $html = $response->html();
    $_instance->logRenderedChild('NMeODhv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/category/create.blade.php ENDPATH**/ ?>