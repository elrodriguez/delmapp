...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::commands.commands-edit', ['commandId' => $id,'command_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('NsFso3Y')) {
    $componentId = $_instance->getRenderedChildComponentId('NsFso3Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('NsFso3Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NsFso3Y');
} else {
    $response = \Livewire\Livewire::mount('restaurant::commands.commands-edit', ['commandId' => $id,'command_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('NsFso3Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/commands/edit.blade.php ENDPATH**/ ?>