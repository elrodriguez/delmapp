...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-cubes'></i><?php echo e(__('setting::labels.roles')); ?> </span> <sup class='badge badge-primary fw-500'>Form</sup>
    </h1>
...
} elseif ($_instance->childHasBeenRendered('8OQda7s')) {
    $componentId = $_instance->getRenderedChildComponentId('8OQda7s');
    $componentTag = $_instance->getRenderedChildComponentTagName('8OQda7s');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8OQda7s');
} else {
    $response = \Livewire\Livewire::mount('setting::roles.roles-form');
    $html = $response->html();
    $_instance->logRenderedChild('8OQda7s', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/roles/index.blade.php ENDPATH**/ ?>