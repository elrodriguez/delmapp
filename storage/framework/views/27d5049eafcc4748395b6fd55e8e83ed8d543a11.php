...
} elseif ($_instance->childHasBeenRendered('zNhiOnk')) {
    $componentId = $_instance->getRenderedChildComponentId('zNhiOnk');
    $componentTag = $_instance->getRenderedChildComponentTagName('zNhiOnk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zNhiOnk');
} else {
    $response = \Livewire\Livewire::mount('inventory::item.item-create');
    $html = $response->html();
    $_instance->logRenderedChild('zNhiOnk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('gviQDB3')) {
    $componentId = $_instance->getRenderedChildComponentId('gviQDB3');
    $componentTag = $_instance->getRenderedChildComponentTagName('gviQDB3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gviQDB3');
} else {
    $response = \Livewire\Livewire::mount('inventory::item.item-create-generic', []);
    $html = $response->html();
    $_instance->logRenderedChild('gviQDB3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php endif; ?>
...
<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/item/create.blade.php ENDPATH**/ ?>