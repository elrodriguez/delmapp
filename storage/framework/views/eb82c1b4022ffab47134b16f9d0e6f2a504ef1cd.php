<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="floorSearch" wire:model.defer="search" type="text"
                    class="form-control border-left-0 bg-transparent pl-0" placeholder="Escriba aquí...">
                <div class="input-group-append">
                    <button wire:click="floorSearch" class="btn btn-default waves-effect waves-themed"
                        type="button"><?php echo e(__('labels.search')); ?></button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_pisos_nuevo')): ?>
                        <a href="<?php echo e(route('restaurant_floors_create')); ?>"
            ...
            <table class="table m-0">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(__('labels.establishment')); ?></th>
                ...
                <tbody class="">
                    <?php if(count($floors) > 0): ?>
                        <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center tdw-50 align-middle">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_pisos_editar')): ?>
                                                <a href="<?php echo e(route('restaurant_floors_edit', $floor->id)); ?>"
                                                    class="dropdown-item">
                                                    <i class="fal fa-pencil-alt mr-1"></i>
                                                    <?php echo e(__('labels.edit')); ?>

                                                </a>
                                            <?php endif; ?>
                                            <div class="dropdown-divider"></div>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_pisos_eliminar')): ?>
                                                <button onclick="confirmDeleteFloor(<?php echo e($floor->id); ?>)" type="button"
                                                    class="dropdown-item text-danger">
                                                    <i class="fal fa-trash-alt mr-1"></i>
                                                    <?php echo e(__('labels.delete')); ?>
                                ...
                                <td class="align-middle"><?php echo e($floor->establishment_name); ?></td>
                                <td class="align-middle"><?php echo e($floor->name); ?></td>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($floors->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDeleteFloor(id) {
            ...
            let box = bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        window.livewire.find('<?php echo e($_instance->id); ?>').deleteFloor(id)
                    }
                }
            });
        ...
        document.addEventListener('set-floor-delete', event => {
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/livewire/floors/floors-list.blade.php ENDPATH**/ ?>