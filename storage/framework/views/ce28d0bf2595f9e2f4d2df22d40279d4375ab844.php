...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::tables.tables-list', [])->html();
} elseif ($_instance->childHasBeenRendered('y1gKAXE')) {
    $componentId = $_instance->getRenderedChildComponentId('y1gKAXE');
    $componentTag = $_instance->getRenderedChildComponentTagName('y1gKAXE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('y1gKAXE');
} else {
    $response = \Livewire\Livewire::mount('restaurant::tables.tables-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('y1gKAXE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/tables/index.blade.php ENDPATH**/ ?>