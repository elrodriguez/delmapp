...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::floors.floors-list', [])->html();
} elseif ($_instance->childHasBeenRendered('wr3ORhQ')) {
    $componentId = $_instance->getRenderedChildComponentId('wr3ORhQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('wr3ORhQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wr3ORhQ');
} else {
    $response = \Livewire\Livewire::mount('restaurant::floors.floors-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('wr3ORhQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/floors/index.blade.php ENDPATH**/ ?>