...
} elseif ($_instance->childHasBeenRendered('VlyRFiZ')) {
    $componentId = $_instance->getRenderedChildComponentId('VlyRFiZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('VlyRFiZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VlyRFiZ');
} else {
    $response = \Livewire\Livewire::mount('restaurant::commands.commands-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('VlyRFiZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/commands/index.blade.php ENDPATH**/ ?>