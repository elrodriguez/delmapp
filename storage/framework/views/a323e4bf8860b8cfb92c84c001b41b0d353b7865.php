...
} elseif ($_instance->childHasBeenRendered('Igr9ZDs')) {
    $componentId = $_instance->getRenderedChildComponentId('Igr9ZDs');
    $componentTag = $_instance->getRenderedChildComponentTagName('Igr9ZDs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Igr9ZDs');
} else {
    $response = \Livewire\Livewire::mount('sales::series.series-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('Igr9ZDs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
