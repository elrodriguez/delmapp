...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo app('translator')->get('inventory::labels.lbl_assets_with_code'); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="fal fa-file-chart-line"></i></i> <?php echo app('translator')->get('inventory::labels.lbl_assets_with_code'); ?><sup class='badge badge-primary fw-500'><?php echo app('translator')->get('inventory::labels.lbl_list'); ?></sup>
    </h1>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('inventory::kardex.active-codes')->html();
} elseif ($_instance->childHasBeenRendered('fmzKHMM')) {
    $componentId = $_instance->getRenderedChildComponentId('fmzKHMM');
    $componentTag = $_instance->getRenderedChildComponentTagName('fmzKHMM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fmzKHMM');
} else {
    $response = \Livewire\Livewire::mount('inventory::kardex.active-codes');
    $html = $response->html();
    $_instance->logRenderedChild('fmzKHMM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/kardex/activecodes.blade.php ENDPATH**/ ?>