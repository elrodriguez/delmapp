...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('labels.bank_accounts')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-piggy-bank"></i></i><?php echo e(__('labels.bank_accounts')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.list')); ?></sup>   
    </h1>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('setting::banks.banks-accounts-list', [])->html();
} elseif ($_instance->childHasBeenRendered('rhJdNr8')) {
    $componentId = $_instance->getRenderedChildComponentId('rhJdNr8');
    $componentTag = $_instance->getRenderedChildComponentTagName('rhJdNr8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rhJdNr8');
} else {
    $response = \Livewire\Livewire::mount('setting::banks.banks-accounts-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('rhJdNr8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/banks/accounts.blade.php ENDPATH**/ ?>