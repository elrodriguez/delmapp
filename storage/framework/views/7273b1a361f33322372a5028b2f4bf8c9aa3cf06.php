...
} elseif ($_instance->childHasBeenRendered('iD5xO1Y')) {
    $componentId = $_instance->getRenderedChildComponentId('iD5xO1Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('iD5xO1Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iD5xO1Y');
} else {
    $response = \Livewire\Livewire::mount('inventory::asset.asset-list');
    $html = $response->html();
    $_instance->logRenderedChild('iD5xO1Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/asset/index.blade.php ENDPATH**/ ?>