...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::commands.commands-create', [])->html();
} elseif ($_instance->childHasBeenRendered('xgKbG0I')) {
    $componentId = $_instance->getRenderedChildComponentId('xgKbG0I');
    $componentTag = $_instance->getRenderedChildComponentTagName('xgKbG0I');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xgKbG0I');
} else {
    $response = \Livewire\Livewire::mount('restaurant::commands.commands-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('xgKbG0I', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Restaurant\Resources/views/commands/create.blade.php ENDPATH**/ ?>