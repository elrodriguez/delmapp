    ...
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="purchaseSearch" wire:model.defer="search" type="text" class="form-control border-left-0 bg-transparent pl-0" placeholder="<?php echo app('translator')->get('inventory::labels.lbl_type_here'); ?>">
                <div class="input-group-append">
                    <button wire:click="purchaseSearch" class="btn btn-default waves-effect waves-themed" type="button"><?php echo app('translator')->get('inventory::labels.btn_search'); ?></button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_compras_nuevo')): ?>
                        <a href="<?php echo e(route('inventory_purchase_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button"><?php echo app('translator')->get('inventory::labels.btn_new'); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        <div class="card-body p-0">
            <table class="table m-0">
                ...
                <tr>
                    ...
                    <th ><?php echo app('translator')->get('inventory::labels.lbl_document_type'); ?></th>
                    <th class="text-center"><?php echo app('translator')->get('labels.broadcast_date'); ?></th>
                    <th ><?php echo app('translator')->get('inventory::labels.lbl_serie'); ?></th>
                    <th ><?php echo app('translator')->get('inventory::labels.lbl_number'); ?></th>
                    <th class="text-center"><?php echo app('translator')->get('inventory::labels.lbl_total'); ?></th>
                    <th ><?php echo app('translator')->get('inventory::labels.lbl_supplier'); ?></th>
                </tr>
                </thead>
                <tbody class="">
                <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_compras_editar')): ?>
                                        <a href="<?php echo e(route('inventory_purchase_edit',$purchase->id)); ?>" class="dropdown-item">
                                            <i class="fal fa-pencil-alt mr-1"></i> <?php echo app('translator')->get('inventory::labels.lbl_edit'); ?>
                                        </a>
                                    <?php endif; ?>
                                    <div class="dropdown-divider"></div>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_compras_eliminar')): ?>
                                        <button onclick="confirmDelete(<?php echo e($purchase->id); ?>)" type="button" class="dropdown-item text-danger">
                        ...
                        <td class="align-middle"><?php echo e($purchase->name_document); ?></td>
                        <td class="align-middle text-center"><?php echo e($purchase->date_of_issue); ?></td>
                        <td class="align-middle"><?php echo e($purchase->serie); ?></td>
                        <td class="align-middle"><?php echo e($purchase->number); ?></td>
                        <td class="align-middle text-right"><?php echo e($purchase->total); ?></td>
                        <td class="align-middle"><?php echo e($purchase->name_supplier); ?></td>
                    </tr>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($purchases->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDelete(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                    window.livewire.find('<?php echo e($_instance->id); ?>').deletePurchase(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\delmapp\Modules/Inventory\Resources/views/livewire/purchase/purchase-list.blade.php ENDPATH**/ ?>