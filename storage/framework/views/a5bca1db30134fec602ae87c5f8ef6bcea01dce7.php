...
} elseif ($_instance->childHasBeenRendered('F8zx7d2')) {
    $componentId = $_instance->getRenderedChildComponentId('F8zx7d2');
    $componentTag = $_instance->getRenderedChildComponentTagName('F8zx7d2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F8zx7d2');
} else {
    $response = \Livewire\Livewire::mount('setting::banks.banks-accounts-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('F8zx7d2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delmapp\Modules/Setting\Resources/views/banks/accounts_create.blade.php ENDPATH**/ ?>