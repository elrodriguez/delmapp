...
<body>
    ...
    <table class="full-width mt-5">
        <tr>
            ...
            <td width="15%">{{ \Carbon\Carbon::parse($document->date_of_issue)->format('Y-m-d') }}</td>
        </tr>
        <tr>
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            @if ($document->total_taxed > 0)
                <tr>
                    <td colspan="7" class="text-right font-bold">OP. GRAVADAS: {{ $document->currency_type->symbol }}
                    </td>
